...
var DBInstance = AWSResource.define('AWS::RDS::DBInstance', {
    ...
    validator: function(context) {
        if (context.properties.DBSnapshotIdentifier && context.properties.DBName) {
            context.addError('Cannot set DBName and DBSnapshotIdentifier');
        }
    },
});
...
var DBParameterGroup = AWSResource.define('AWS::RDS::DBParameterGroup', {
    ...
    Parameters : { type: types.jsonkeyvalues },
    Tags : { type: types.tags },
});
