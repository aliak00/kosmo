        ...
        return {
            ...
            validate: function(x) {
                if (!(x instanceof CFFunction.ref)
                    ...
                    return 'expected AWSResource or CFFunction.ref';
                }
            },
    ...
    string: {
        ...
        validate: function(x) {
            if (typeof x !== 'string'
                ...
                return `expected string, AWSResource or CFFunction - got ${x}`;
            }
        },
        toCloudFormationValue: function(x) {
            Types.ensureValueValid(this, x);
            ...
            try {
                _.forEach(x, tagValue => {
                    ...
                    if (typeof tagData.value !== 'string' &&
                        ...
                        !(tagData.value instanceof CFFunction)) {
                        throw `expected instance of string, AWSResource, or CFFunction - got ${x}`;
                    }
                ...
                _.forEach(x, (propertyValue, propertyName) => {
                    ...
                    if (propertyDefinition.validators instanceof Array) {
                        _.forEach(propertyDefinition.validators, validator => {
                            var validationResult = validator(x);
