...
Command.prototype.execute = function() {
    ...
    return Promise.all(artifactPromises).then(values => {
        ...
        _.forEach(artifacts, (artifact, name) => {
            ...
            console.log(`  Build date: ${moment.utc(artifact.timestamp).format(this.dateFormat)}`);
        ...
        _.forEach(stacks, (stack, name) => {
            ...
            console.log(`  Deploy date: ${moment.utc(stack.outputs.kosmoId).format(this.dateFormat)}`);
