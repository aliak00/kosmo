...
Command.prototype.execute = function() {
    ...
    this.comopnentDef = this.project.findComponent(this.componentName);
    if (!this.comopnentDef) {
    ...
    return Promise.all(stackInfoPromises).then(values => {
        ...
        return utils.pdone(this.componentDef.build, this.componentDef, dependencyObject);
    }).then(buildResult => {
