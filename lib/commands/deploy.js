...
function fetchArtifactDependencies(artifactRefs, region) {
...
Command.prototype.execute = function() {
    ...
    return fetchDependencies(this.project.getDependencies(this.componentDef.name), thisRef).then(dependencyData => {
        ...
        return utils.pdone(this.componentDef.build, this.componentDef, this.dependencyObject);
    }).then(buildResult => {
        ...
        return upload({
            ...
            var params = {
                ...
                NotificationARNs: notifactionArns,
                Parameters: parameters,
            };
            
            var notifactionArns;
            if (typeof this.componentDef.notifactionArns === 'function') {
                notifactionArns = this.componentDef.notifactionArns(this.dependencyObject);
                if (!(notifactionArns instanceof Array)) {
                    notifactionArns = [notifactionArns];
                }
                params.NotificationARNs = notifactionArns;
            }
