...
function mktags(str, visibility, az) {
    return {
        ...
        Name: novaform.fn.join('-', [novaform.refs.StackName, str]),
        Network: visibility,
        AZ: az,
    };
}
...
function Vpc(options) {
    ...
    this.vpc = this._addResource(novaform.ec2.VPC(name, {
        ...
        Tags: {
            Application: novaform.refs.StackId,
            Name: novaform.fn.join('-', [novaform.refs.StackName, name]),
        },
    }));
    ...
    this.internetGateway = this._addResource(novaform.ec2.InternetGateway(mkname('Igw'), {
        Tags: {
            Application: novaform.refs.StackId,
            Name: novaform.fn.join('-', [novaform.refs.StackName, mkname('Igw')]),
            Network: 'public',
        },
    }));
