...
var ConfigurationTemplate = AWSResource.define('AWS::ElasticBeanstalk::ConfigurationTemplate', {
    ...
    OptionSettings: { type: types.array(ConfigurationTemplateOptionSettingsType) },
...
var EnvironmentOptionSettingType = ConfigurationTemplateOptionSettingsType;
...
var Environment = AWSResource.define('AWS::ElasticBeanstalk::Environment', {
    ...
    OptionSettings: { type: types.array(EnvironmentOptionSettingType) },
