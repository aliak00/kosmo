...
var TaskDefintionContainerDefiniton = types.object('ecs-taskdefinition-containerdefinition', {
    ...
    Environment: types.array(TaskDefintionContainerDefinitonEnvironment),
    Essential: types.boolean,
    Image: types.string, // required
    Links: types.array,
    Memory: types.number, // required
    MountPoints: types.array(TaskDefintionContainerDefinitonMountPoints),
    Name: types.string, // required
    PortMappings: types.array(TaskDefintionContainerDefinitonPortMappings),
    VolumesFrom: types.array(TaskDefintionContainerDefinitonVolumesFrom),
});
...
var TaskDefinition = AWSResource.define('AWS::ECS::TaskDefinition', {
    ContainerDefinitions: { type: types.array(TaskDefintionContainerDefiniton), required: true },
    Volumes: { type: types.array(TaskDefintionVolumes), required: true },
});
