...
var EC2SecurityGroupIngressRule = types.object('ec2-security-group-ingress-rule', { // eslint-disable-line no-unused-vars
...
var EC2SecurityGroupEgressRule = types.object('ec2-security-group-egress-rule', { // eslint-disable-line no-unused-vars
    CidrIp: types.cidr, // conditional
    FromPort: types.number, // required
    IpProtocol: types.protocol, // required
