...
var NetworkAclEntryIcmpType = types.object('ec2-network-acl-entry-icmp', {
    Code: types.number, // conditional
    Type: types.number, // conditional
});

var NetworkAclEntry = AWSResource.define('AWS::EC2::NetworkAclEntry', {
    CidrBlock: { type: types.cidr, required: true },
    Egress: { type: types.boolean, required: true },
    Icmp: { type: NetworkAclEntryIcmpType, required: 'conditional' },
...
var SecurityGroup = AWSResource.define('AWS::EC2::SecurityGroup', {
    ...
    SecurityGroupEgress: { type: types.array(EC2SecurityGroupEgressRule) },
    SecurityGroupIngress: { type: types.array(EC2SecurityGroupIngressRule) },
    Tags : { type: types.tags },
...
var EC2InstanceNetworkInterfacePrivateIpAddressType = types.object('ec2-instance-network-interface-private-ip-address', {
    PrivateIpAddress: types.string, // required
    Primary: types.boolean, // required
});

var EC2InstanceBlockDeviceMappingEbsType = types.object('ec2-instance-block-device-mapping-ebs', {
    DeleteOnTermination: types.boolean,
    Encrypted: types.boolean,
    Iops: types.number, // conditional
    SnapshotId: types.string, // conditional
    VolumeSize: types.string, // conditional
    VolumeType: types.string,
});

var EC2InstanceBlockDeviceMappingType = types.object('ec2-instance-block-device-mapping', {
    DeviceName: types.string, // required
    Ebs: types.array(EC2InstanceBlockDeviceMappingEbsType), // conditional
    NoDevice: types.emptymap,
    VirtualName: types.string, // conditional
});

var EC2InstanceNetworkInterfaceTypes = types.object('ec2-instance-network-interface', {
    AssociatePublicIpAddress: types.boolean,
    DeleteOnTermination: types.boolean,
    Description: types.string,
    DeviceIndex: types.string, // required
    GroupSet: types.array(types.string),
    NetworkInterfaceId: types.string, // conditional (on SubnetId)
    PrivateIpAddress: types.string,
    PrivateIpAddresses: types.array(EC2InstanceNetworkInterfacePrivateIpAddressType),
    SecondaryPrivateIpAddressCount: types.number,
    SubnetId: types.string, // conditional
});

var EC2InstanceSsmAssociationParameterType = types.object('ec2-instance-network-ssm-association-parameter', {
    Key: types.string, // required
    Value: types.array(types.string), // required
});

var EC2InstanceSsmAssociationType = types.object('ec2-instance-network-ssm-association', {
    AssociationParameters: types.array(EC2InstanceSsmAssociationParameterType),
    DocumentName: types.string, // required
});

var EC2InstanceMountPointType = types.object('ec2-instance-mount-point', {
    Device: types.string, // required
    VolumeId: types.string, // required
});

var Instance = AWSResource.define('AWS::EC2::Instance', {
    AvailabilityZone: { type: types.string },
    BlockDeviceMappings: { type: types.array(EC2InstanceBlockDeviceMappingType) },
    ...
    NetworkInterfaces: { type: types.array(EC2InstanceNetworkInterfaceTypes) },
    PlacementGroupName: { type: types.string },
    PrivateIpAddress: { type: types.string },
    RamdiskId: { type: types.string },
    SecurityGroupIds: { type: types.stringarray(types.string), required: 'conditional' },
    SecurityGroups: { type: types.stringarray(types.string) },
    SsmAssociations: { type: types.array(EC2InstanceSsmAssociationType) },
    ...
    Volumes: { type: types.array(EC2InstanceMountPointType) },
});
