...
var AutoScalingGroupMetricsCollectionType = types.object('asg-metrics-collection', {
    Granularity: types.string, // required
    Metrics: types.array(types.string), // conditional
});

var AutoScalingGroupNotificationConfigurationType = types.object('asg-notification-configuration', {
    NotificationTypes: types.array(types.string),
...
var AutoScalingGroup = AWSResource.define('AWS::AutoScaling::AutoScalingGroup', {
    ...
    MetricsCollection : { type: types.array(AutoScalingGroupMetricsCollectionType) },
