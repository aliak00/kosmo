...
var Policy = types.object('elb-policy', {
    Attributes: types.array(PolicyAttributeType),
    InstancePorts: types.array(types.string),
    LoadBalancerPorts: types.array(types.string),
    PolicyName: types.string, // required
...
var ListenerPropertyType = types.object('elb-listener-property-type', {
    ...
    PolicyNames: types.array(types.string),
