...
var HealthCheckTagType = types.object('HealthCheckTag', {
...
var HostedZoneTagType = types.object('HostedZoneTag', {
    Key: { type: types.string, required: true },
    Value: { type: types.string, required: true },
});
...
var RecordSet = AWSResource.define('AWS::Route53::RecordSet', {
    AliasTarget: { type: AliasTargetType, required: 'conditional', validators: [AliasTargetValidator] },
    Comment: { type: types.string },
